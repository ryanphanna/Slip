...
Voided lines: POS systems sometimes print a "Line Void" or reversal entry directly after an item to cancel it (net effect $0), often followed by a reason code like "Customer changed mind". Recognize this pattern and omit both the original item and its void from the item list entirely — do not turn the reason code into a fabricated separate item.
