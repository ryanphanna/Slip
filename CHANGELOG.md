...
- **Phone sign-in reliability**: attaches invisible reCAPTCHA to the sign-in action and resets it after failed requests, preventing stale or duplicate verification state on localhost.
