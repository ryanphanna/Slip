...
- **Confidence Scoring**: Have Gemini return a confidence score for each field. Flag low-confidence parses for manual review instead of silently saving bad data. (✅ Done - implemented as Pro fallback + SMS warning)
